...
function($scope, $state, $sce, queryService, DTOptionsBuilder, DTColumnBuilder, $localStorage, $compile, $rootScope, globalFunction,API_URL) {
    ...
    $scope.table = 'ref_hist_revenue_grade'
    ...
    $scope.exportExcel = function(){
        ...
        .then(function(data){
            $scope.exportData = [];
            //Header
            $scope.exportData.push(["Code", "Name", 'Description','Status','Grade','Total Spend Begin','Total Spend End']);
            //Data
    ...
    $scope.dtColumns.push(
        ...
        DTColumnBuilder.newColumn('total_spend_begin').withTitle('Total Spend Begin'),
        DTColumnBuilder.newColumn('total_spend_end').withTitle('Total Spend End')
    );
    ...
    $scope.update = function(obj){
        ...
        .then(function(result){
            ...
            $scope.field.total_spend_begin = result.data[0].total_spend_begin
            $scope.field.total_spend_end = result.data[0].total_spend_end
