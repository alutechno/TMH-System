        ...
        $ocLazyLoadProvider.config({
            ...
            modules: [{
                    ...
                    files: [
                        ...
                        'container/plugins/angular-ui-select/select.min.git.css',
                        //'assets/plugins/angular-ui-select/select.min.js'
                        'container/plugins/angular-ui-select/select.min.git.js'
                    ]
                }, {
                    name: 'datepicker',
                    files: [
                    ...
                    name: 'angulardataTables',
                    files: [
                        'assets/plugins/jquery-datatable/media/js/jquery.dataTables.min.js',
                        'assets/plugins/angular-datatables/angular-datatables.min.js',
                        'assets/plugins/angular-datatables/angular-datatables.min.css'
                    ],
                    serie: true // load in the exact order
                }, {
                    name: 'google-map',
